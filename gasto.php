...
/* TARJETA RESUMEN GASTOS */
.summary-card{background:linear-gradient(135deg,var(--danger) 0%,#f87171 100%);color:white;padding:1.5rem;border-radius:12px;margin-bottom:2rem;display:flex;align-items:center;gap:1rem}
...
.category-badge{display:inline-flex;align-items:center;gap:0.5rem;padding:0.25rem 0.75rem;border-radius:20px;font-size:0.875rem;font-weight:500}
...
.modal-custom .modal-header{background:linear-gradient(135deg,var(--danger) 0%,#f87171 100%);color:white;border-radius:12px 12px 0 0;border:none;padding:1.5rem}
...
.btn-submit{background:linear-gradient(135deg,var(--danger) 0%,#f87171 100%);border:none;padding:0.75rem 2rem;border-radius:6px;color:white;font-weight:600;width:100%;transition:all 0.3s ease}
.btn-submit:hover{transform:translateY(-2px);box-shadow:0 4px 12px rgba(239,68,68,0.3)}
...
@media (max-width:480px){
    ...
    .sidebar{width:260px}
    .category-badge{font-size:0.8rem;padding:0.2rem 0.5rem}
}
    ...
    <nav class="sidebar" id="sidebar">
        ...
        <div class="nav-links">
            ...
            <div class="nav-section">
                ...
                <a href="./gasto.php" class="nav-link active" onclick="closeSidebarOnMobile()">
